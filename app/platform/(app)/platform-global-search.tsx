  ...
  return (
    <div className={clsx("relative space-y-2", open && "z-[120]")} ref={boxRef}>
      ...
      <div className="relative">
        ...
        {open && normalized && (
          <div className="absolute z-[130] mt-2 w-full overflow-hidden rounded-[16px] border border-white/[0.14] bg-[#111a2d]/95 backdrop-blur-2xl shadow-[0_16px_50px_-20px_rgba(0,0,0,0.8)]">
